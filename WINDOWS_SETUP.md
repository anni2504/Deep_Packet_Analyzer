...
3. Navigate to the `Deep_Packet_Analyzer` folder and click "Select Folder"
...
2. Navigate to the project:
   ```cmd
   cd C:\path\to\Deep_Packet_Analyzer
   ```
...
```bash
# If your project is at C:\Users\YourName\Downloads\Deep_Packet_Analyzer
cd /mnt/c/Users/YourName/Downloads/Deep_Packet_Analyzer
```
...
1. **File → Open Folder**
2. Select the `Deep_Packet_Analyzer` folder
...
**Fix:**
Make sure you're in the `Deep_Packet_Analyzer` folder:
```cmd
cd C:\full\path\to\Deep_Packet_Analyzer
dir include
```
